...
With the help of a Claude Code agent, we ported an existing CUDA library ([GPUfit](https://github.com/gpufit/Gpufit)) to WebGPU. The results of this port are available in the [gpufit-wgpu](https://github.com/vrbouza/gpufit-wgpu) GitHub repository.
